...
@WebServlet(name = "TicketListar", urlPatterns = {"/TicketListar"})
public class TicketListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            System.out.println("Problemas no Servlet ao Listar tickets! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
